...
public class T30_ImgTrans_canny_detector_CannyDetectorDemo {
    ...
    public T30_ImgTrans_canny_detector_CannyDetectorDemo(String[] args) {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new T30_ImgTrans_canny_detector_CannyDetectorDemo(args);
            }
        });
    }
}
