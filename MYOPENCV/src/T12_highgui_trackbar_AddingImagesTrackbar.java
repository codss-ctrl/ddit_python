...
public class T12_highgui_trackbar_AddingImagesTrackbar {
    ...
    public T12_highgui_trackbar_AddingImagesTrackbar(String[] args) {
        //! [load]
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new T12_highgui_trackbar_AddingImagesTrackbar(args);
            }
        });
    }
}
