...
public class T28_ImgProc_threshold_inRange_ThresholdInRange {
    ...
    public T28_ImgProc_threshold_inRange_ThresholdInRange(String[] args) {
        int cameraDevice = 0;
        if (args.length > 0) {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new T28_ImgProc_threshold_inRange_ThresholdInRange(args);
            }
        });
    }
}
