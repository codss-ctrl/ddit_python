...
class MyDaoSdetail:
    ...
    def myselect(self,survey_id):
        ...
        list = []
        for record in rs:
            list.append({'survey_id':record[0],'s_seq':record[1],'question':record[2],'a1':record[3],'a2':record[4],'a3':record[5], 'a4':record[6], 'in_date':record[7],'in_user_id':record[8],'up_date':record[9],'up_user_id':record[10],'in_user_id':record[11]})
        return list
