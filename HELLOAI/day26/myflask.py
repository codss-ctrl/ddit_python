...
import cx_Oracle
from day26.mydao_suser import MyDaoSuser
from day26.mydao_survey import MyDaoSurvey
from day26.mydao_sdetail import MyDaoSdetail
from day26.mydao_starget import MyDaoStarget
...
def join_ajax():
    ...
    content = user_name+"님!!!^^ \n "+"당신의 계정은"+ user_id+"이고 비밀번호는 1입니다. 로그인 후 변경바랍니다."
